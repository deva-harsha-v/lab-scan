  ...
  return (
    <>
      ...
      <div style={{ minHeight: '100vh', background: tokens.bgPage, position: 'relative', transition: 'background 0.3s ease' }}>
        ...
        {/* ── HERO ───────────────────────────────────────────────────────── */}
        <section style={{
          width: '100%', minHeight: '100vh', padding: '80px 60px 40px',
          ...
          <div style={{ display: 'flex', flexDirection: 'column', textAlign: 'left', position: 'relative', zIndex: 2 }}>
            ...
            <h1 style={{
              ...
              fontSize: 'clamp(3rem, 5.2vw, 6rem)', lineHeight: 0.95,
              letterSpacing: '-0.04em', color: tokens.textPrimary, marginBottom: 28
            }}>
              The operating system for laboratory education.
            </h1>

            <p style={{ fontSize: 16, color: tokens.textMuted, lineHeight: 1.6, maxWidth: 520, marginBottom: 40 }}>
        ...
        {/* ── STATS ─────────────────────────────────────────────────────── */}
        <section style={{ width: '100%', padding: '40px 60px', borderTop: `1px solid ${tokens.border}`, borderBottom: `1px solid ${tokens.border}`, background: isDark ? 'rgba(255,255,255,0.005)' : 'rgba(0,0,0,0.005)', position: 'relative', zIndex: 1 }}>
        ...
        {/* ── PRODUCT SHOWCASE ──────────────────────────────────────────── */}
        <section id="showcase" style={{ width: '100%', padding: '100px 60px', maxWidth: 1240, margin: '0 auto', position: 'relative', zIndex: 1 }}>
