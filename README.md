...
### ArUco Markers
- Generate ArUco markers at: https://chev.me/arucogen/
- Use **Dictionary: 4x4 (50)** and the marker ID matching the experiment's `arucoId`
- Print and attach to physical experiment cards
